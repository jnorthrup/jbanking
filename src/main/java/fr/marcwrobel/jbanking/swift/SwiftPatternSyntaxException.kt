...
/**
 * Constructs a `SwiftPatternSyntaxException` with the expression that caused the error and the given detail message.
 *
...
internal constructor(
         ...
         * @return a string
         */
        val expression: String) : RuntimeException(String.format("the expression syntax is invalid in '%s'", expression))
